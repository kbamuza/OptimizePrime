...
namespace OptimizePrime.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdminID,Name,Surname,JobTitle,UserID")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdminID,Name,Surname,JobTitle,UserID")] Admin admin)
        {
            if (ModelState.IsValid)
            {
